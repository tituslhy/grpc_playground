...
class GreeterStub(object):
    """Define your service with RPC methods
    """
    ...
    def __init__(self, channel):
        ...
        self.SayHelloStream = channel.unary_stream(
                '/helloservice.Greeter/SayHelloStream',
                request_serializer=hello__pb2.HelloRequest.SerializeToString,
                response_deserializer=hello__pb2.HelloResponse.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'helloservice.Greeter', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('helloservice.Greeter', rpc_method_handlers)
